...
public interface UnfCons {
    ...
    /** whethetr to use the class Normalizer instead of the final encoding*/
    boolean normalizeText = false;
    /** posix end of line*/
    ...
    /** to transpose matrices for unf calculations */
    static boolean transpose = false;
